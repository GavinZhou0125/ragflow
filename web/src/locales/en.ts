  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      modelEnabledMcpServersTip:
        'Please select one or more MCP servers for the chat model to use. It takes no effect for models not supporting tool call.',
      freedom: 'Freedom',
      improvise: 'Improvise',
      precise: 'Precise',
      balance: 'Balance',
    ...
    setting: {
      ...
      mcpServerVariablesTip:
        'Define variables which can be used in the HTTP headers',
      mcpServerVariableKey: 'Variable key',
      mcpServerVariableName: 'Variable name',
      mcpServerHeaders: 'HTTP Headers',
      mcpServerHeadersTip:
        'Define headers that will be sent to the MCP server. Can use variables in the form ${key}',
...
This delimiter is used to split the input text into several text pieces echo of which will be performed as input item of each iteration.`,
      ...
      useLatestMessageOnlyTip:
        'If you are using output from the Answer component, enabling this will only use the latest one history message from it for retrieval.',
      code: 'Code',
